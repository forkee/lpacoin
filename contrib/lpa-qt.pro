...
RESOURCES += src/qt/lpa.qrc src/qt/lpa_locale.qrc

TRANSLATIONS += src/qt/locale/lpa_bg.ts \
                src/qt/locale/lpa_de.ts \
                src/qt/locale/lpa_en.ts \
                src/qt/locale/lpa_es.ts \
                src/qt/locale/lpa_fi.ts \
                src/qt/locale/lpa_fr.ts \
                src/qt/locale/lpa_it.ts \
                src/qt/locale/lpa_ja.ts \
                src/qt/locale/lpa_pl.ts \
                src/qt/locale/lpa_pt.ts \
                src/qt/locale/lpa_ru.ts \
                src/qt/locale/lpa_sk.ts \
                src/qt/locale/lpa_sv.ts \
                src/qt/locale/lpa_vi.ts \
                src/qt/locale/lpa_zh_CN.ts \
                src/qt/locale/lpa_zh_TW.ts
