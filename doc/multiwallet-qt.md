...
In order to support loading of multiple wallets in lpa-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lpa.cpp.
...
Changes to lpa.cpp
----------------------
lpa.cpp is the entry point into lpa-qt, and as such, will require some minor modifications to provide hooks for
