...
static const uint64_t BLOCK_CHAIN_SIZE = 1LL * GB_BYTES + 1000LL;
...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("LPA Core"),
     ...
     * override -datadir in the lpa.conf file in the default data directory
     * (to be consistent with lpad behavior)
     */
    if (dataDir != getDefaultDataDirectory())
