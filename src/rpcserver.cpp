...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LPA features */
        {"lpa", "masternode", &masternode, true, true, false},
        {"lpa", "masternodelist", &masternodelist, true, true, false},
        {"lpa", "mnbudget", &mnbudget, true, true, false},
        {"lpa", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"lpa", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lpa", "mnsync", &mnsync, true, true, false},
        {"lpa", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"lpa", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use lpad, or the -server option to lpa-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> lpa-cli " + methodname + " " + args + "\n";
}
